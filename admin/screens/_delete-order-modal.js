 ...
 * (по прямому запросу VASY). Второе, финальное окно подтверждения (общая
 * showConfirmModal, common.js) — уже в order-edit.js, ПОСЛЕ закрытия этой
 * модалки (двойной гейт).
 *
 * Использование:
